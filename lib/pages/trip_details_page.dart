    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFareRow('Base Fare', '৳${(widget.price - 10).toStringAsFixed(0)}'),
          const SizedBox(height: 12),
          _buildFareRow('Service Fee', '৳10'),
          const Divider(height: 40),
          _buildFareRow('Total Fare', '৳${widget.price.toStringAsFixed(0)}', isTotal: true),
